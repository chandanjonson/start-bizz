...
exports.toBlobEndpointUrl = toBlobEndpointUrl;
exports.toDfsEndpointUrl = toDfsEndpointUrl;
exports.toFileSystemPagedAsyncIterableIterator = toFileSystemPagedAsyncIterableIterator;
exports.toContainerPublicAccessType = toContainerPublicAccessType;
exports.toPublicAccessType = toPublicAccessType;
exports.toProperties = toProperties;
exports.toRolePermissions = toRolePermissions;
exports.toPermissions = toPermissions;
exports.toAccessControlItem = toAccessControlItem;
exports.toRemoveAccessControlItem = toRemoveAccessControlItem;
exports.toAcl = toAcl;
exports.toRemoveAcl = toRemoveAcl;
exports.toAccessControlItemString = toAccessControlItemString;
exports.toAclString = toAclString;
exports.toRolePermissionsString = toRolePermissionsString;
exports.toPermissionsString = toPermissionsString;
exports.toAccessControlChangeFailureArray = toAccessControlChangeFailureArray;
exports.toBlobCpkInfo = toBlobCpkInfo;
...
function toBlobEndpointUrl(url) {
    return mapHostUrl(url, constants_js_1.ToBlobEndpointHostMappings, "toBlobEndpointUrl");
}
/**
...
function toDfsEndpointUrl(url) {
    return mapHostUrl(url, constants_js_1.ToDfsEndpointHostMappings, "toDfsEndpointUrl");
}
...
function toProperties(metadata) {
    ...
    for (const key in metadata) {
        if (Object.prototype.hasOwnProperty.call(metadata, key)) {
            ...
            properties.push(`${key}=${(0, utils_common_js_1.base64encode)(value)}`);
        }
    }
...
function toRemoveAccessControlItem(aclItemString) {
    const error = new RangeError(`toAccessControlItem() Parameter access control item string "${aclItemString}" is not valid.`);
    if (aclItemString === "") {
        throw error;
    }
...
function toRemoveAcl(aclString) {
    if (aclString === undefined || aclString === "" || aclString === null) {
        return [];
    }
    const acls = [];
